...
import com.example.rishabhvishwakarma.medifriend.About;
    ...
    private class ShowSelectedSymptoms extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            if (showSelectedSymptoms) {
                ...
                com.example.rishabhvishwakarma.medifriend.medical.ShowSelectedSymptoms selectedSymptomsFragment = new com.example.rishabhvishwakarma.medifriend.medical.ShowSelectedSymptoms();
                Bundle args = new Bundle();
                args.putStringArrayList("selectedSymptoms", selectedSymptoms);
