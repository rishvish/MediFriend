...
import com.example.rishabhvishwakarma.medifriend.LoginActivity;
...
/*
 * Created by Rishabh on 16/01/2019.
 */
...
public class Introduction extends AppIntro2 {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addSlide(AppIntroFragment.newInstance("Hey there!", "Welcome to MediFriend!\nCheck for possible diseases by choosing symptoms or view symptoms and remedies of a particular conditions.",
                R.drawable.logo, rgb(26,188,156)));
        ...
        addSlide(AppIntroFragment.newInstance("Reminder Services", "So you never forget to take a medicine.",
                R.drawable.ic_doctor_intro, rgb(102,102,153)));

        addSlide(AppIntroFragment.newInstance("Reports Storage", "It's better to have all medical reports easily accessible and stored centrally in a secure manner.",
                R.drawable.reports, rgb(255,117,26)));
        ...
        addSlide(AppIntroFragment.newInstance("Cancer Scans", "Scan MRIs to get a second opinion for the doctor's response",
                R.drawable.mri, rgb(134,45,89)));

        addSlide(AppIntroFragment.newInstance("Medical News", "Get all the latest news in the field of medicine at your finger tips.",
                R.drawable.news, rgb(83,121,121)));
